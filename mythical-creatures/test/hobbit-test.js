...
describe('Hobbit', function() {
  ...
  it('should be considered old at the age of 101', function() {
    ...
    //Added test for initial construction of old hobbit
    var pippin = createHobbit('Pippin', 103);
    assert.equal(pippin.age, 103);
    assert.equal(pippin.isAdult, true);
    assert.equal(pippin.isOld, true)
  });
